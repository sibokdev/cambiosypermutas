...
import app.cambiosypermutas.cliente.models.Respuestas;
...
public class BovedaClient {
    ...
    public interface APIBovedaClient {
        ...
        @GET("client/getAll{phone}")
        Call<List<Busqueda>> getTodos(@Path("phone") String phone);
...
//____________________
        ...
        @GET("client/getPuntos{phone}")
        Call<List<Datos>> getPuntos(@Path("phone") String phone);
        ...
        @POST("client/getNewInformation")
        @FormUrlEncoded
        Call<List<Busqueda>> getNewInfo(@FieldMap HashMap<String, String> params);
        ...
        @PUT("client/updatePuntos")
        @FormUrlEncoded
        Call<Responses> updatePuntos(@FieldMap HashMap<String, String> params);
