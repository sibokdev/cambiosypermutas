...
import app.cambiosypermutas.cliente.models.ModelsDB.Preguntas1;
import app.cambiosypermutas.cliente.models.Responses;
import app.cambiosypermutas.cliente.storage.ModelsBD.Oficios;
...
public class ProveedorDeServicios extends BaseActivity implements View.OnClickListener {

    private EditText et_ap1, et_ap2, INE, pass, mail, et_nombre, pass2, res1, res2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.proveedor_servicios);
        ...
        FechaN = (TextView) findViewById(R.id.tvApareceFecha);
        tv_ofi = (TextView) findViewById(R.id.oficios);
        res1 = (EditText) findViewById(R.id.res1);
        res2 = (EditText) findViewById(R.id.res2);
        rb_si = (RadioButton) findViewById(R.id.si);
        rb_no = (RadioButton) findViewById(R.id.no);
        rb_si1 = (RadioButton) findViewById(R.id.si1);
        rb_no1 = (RadioButton) findViewById(R.id.no1);
        ...
        ine = (TextInputLayout) findViewById(R.id.ti_Ine);
        ...
        bt_inefront = (Button) findViewById(R.id.bt_inefront);
        bt_ineback = (Button) findViewById(R.id.bt_ineback);
        phone = (TextView) findViewById(R.id.phone);
        img_inefront = (ImageView) findViewById(R.id.img_INEFront);
        tv_inefront = (TextView) findViewById(R.id.tv_inefront);
        img_ineback = (ImageView) findViewById(R.id.img_ineback);
        tv_ineback = (TextView) findViewById(R.id.tv_ineback);
        ...
        bt_inefront.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        bt_ineback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                abrircamara1();
            }
        ...
        tv_ofi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ProveedorDeServicios.this);
        ...
        pass2.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                ...
                if (strPass1.equals(strPass2)) {
                    ...
                    pw2.setError("contraseñas diferentes");
        ...
        pass.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (passw.matcher(inputText).matches() == false) {
                    pw.setError("Debes ingresar al menos 8 caracteres");
                } else {
    ...
    public void siguiente(View view) {
        ...
        if (pat.matcher(INE.getText().toString()).matches() == false) {
            ine.setError("Ingresa clave del INE (Solo Mayusculas)");
        } else {
            ine.setErrorEnabled(false);
            if (et_nombre.length() == 0) {
                ...
                if (res1.length() == 0) {
                    ...
                    if (res2.length() == 0) {
                        ...
                        if (et_ap1.length() == 0) {
                            ap1.setError("Ingresa Apellido Paterno");
                        } else {
                            ap1.setErrorEnabled(false);
                            if (et_ap2.length() == 0) {
                                ap2.setError("Ingresa Apellido Materno");
                            } else {
                                ap2.setErrorEnabled(false);
                                if (pater.matcher(mail.getText().toString()).matches() == false) {
                                    m.setError("Ingresa un correo valido");
                                } else {
                                                            ...
                                                            public void onResponse(Call<Responses> call, Response<Responses> response) {
                                                                if (response.isSuccessful()) {
                                                                    if (response.body().getCode() == 200) {
                                                                        ...
                                                                        sigue.putExtra("INEKey", INE.getText().toString());
